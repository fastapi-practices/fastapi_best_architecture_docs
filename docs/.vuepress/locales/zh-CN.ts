export default {
  ...
  featureBento: {
    title: '企业级开发，开箱即用',
    subtitle: '三层架构打底，插件生态扩展，AI 贯穿协作',
    architectureTitle: '三层架构打底',
    architectureDesc:
      'API → Service → CRUD/DAO 分层，边界清晰，配套代码生成，新人 30 分钟即可上手',
    pluginTitle: '插件生态扩展',
    pluginDesc: 'AI、Auth、Storage、Notification 装即用、卸即净，企业可自建私有仓库',
    aiTitle: 'AI 项目上下文',
    aiDesc: 'fba skills + LLMs.txt 让 Claude Code、Cursor、Codex 等直接读懂项目规范',
    authTitle: '认证权限内置',
    authDesc: 'JWT、RBAC、数据权限、OAuth 2.0 等企业基础件预置',
    opsTitle: '缓存队列与运维',
    opsDesc: 'Redis、Celery、全链路日志、时区方案按需启用',
    dockerTitle: '一键容器部署',
    dockerDesc: 'Docker Compose 编排就位，MySQL / PostgreSQL 生产可用',
  },
  projectStats: {
    title: '开源驱动，社区共建',
  ...
  sponsors: {
    ...
    boothTitle: '展位赞助',
    boothDesc: '适合希望触达 fba 文档读者的产品或服务。请先联系作者确认价格、排期和素材',
    contactEmail: '邮件联系',
    ...
    inquiryLabel: '咨询:',
    inquiryDesc: '联系作者时可直接发送以下信息，方便快速确认价格、排期和展示素材',
    copyInquiry: '复制咨询模板',
    copiedInquiry: '已复制咨询模板',
    copy: '复制',
    copied: '已复制',
    noticeLabel: '注意:',
    noticeText: '由于当前所有展位赞助均为自愿支持性质，我们暂时无法为您提供发票开具服务，对此带来的不便深表歉意',
    warningLabel: '警告:',
    warningText: '展位转化效果可能因市场环境、受众行为等多种因素影响，我们无法保证确切的转化结果',
    statusVacant: '空缺',
    statusFull: '已满',
    pricePerMonth: '沟通 / 月',
    booths: [
