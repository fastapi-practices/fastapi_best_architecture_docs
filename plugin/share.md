...
1. 创建插件 Github 仓库
   ...
   推荐通过 [fba\_plugin\_template](https://github.com/fastapi-practices/fba_plugin_template)
...
1. 创建个人插件仓库
   ...
   推荐通过 [fba\_ui\_plugin\_template](https://github.com/fastapi-practices/fba_ui_plugin_template) 创建，原因与后端相同

2. 上传代码

   将在 fba\_ui 中开发好的所有插件代码提交到刚刚创建的插件 Github
